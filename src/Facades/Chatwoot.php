 ...
 * @method static array createConversation(\Alan01777\LaravelChatwoot\DTOs\ConversationDTO $data)
 * @method static array updateConversation(int $id, \Alan01777\LaravelChatwoot\DTOs\ConversationDTO $data)
 ...
 * @method static array getAccountSummary(?\Alan01777\LaravelChatwoot\DTOs\ReportCriteriaDTO $params = null)
 * @method static array getAgentSummary(int $agentId, ?\Alan01777\LaravelChatwoot\DTOs\ReportCriteriaDTO $params = null)
 * @method static array getInboxSummary(int $inboxId, ?\Alan01777\LaravelChatwoot\DTOs\ReportCriteriaDTO $params = null)
 * @method static array getMetrics(string $metric, ?\Alan01777\LaravelChatwoot\DTOs\ReportCriteriaDTO $params = null)
 * @method static array getConversationStats(?\Alan01777\LaravelChatwoot\DTOs\ReportCriteriaDTO $params = null)
 * @method static array getSummaryReport(string $type, ?\Alan01777\LaravelChatwoot\DTOs\ReportCriteriaDTO $params = null)
